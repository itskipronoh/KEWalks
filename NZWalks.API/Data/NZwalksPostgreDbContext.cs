...
{
    public class NZWalksPostgreDbContext : DbContext
    {
        public NZWalksPostgreDbContext(DbContextOptions<NZWalksPostgreDbContext> dbContextOptions) : base(dbContextOptions)
        {
        }
